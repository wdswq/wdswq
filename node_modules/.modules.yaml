...
hoistedDependencies:
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@20.19.24)(ts-node@10.9.2):
    jest-cli: private
  /jest-config/29.7.0(@types/node@20.19.24)(ts-node@10.9.2):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
  ...
  /ts-loader/9.5.4(typescript@5.9.3)(webpack@5.102.1):
    ts-loader: private
  /ts-node-dev/2.0.0(@types/node@20.19.24)(typescript@5.9.3):
    ts-node-dev: private
  /ts-node/10.9.2(@types/node@20.19.24)(typescript@5.9.3):
    ts-node: private
...
pendingBuilds: []
prunedAt: Sat, 01 Nov 2025 16:21:11 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - /fsevents/2.3.3
storeDir: /home/engine/.local/share/pnpm/store/v3
